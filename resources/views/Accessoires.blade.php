    ...
    <div class ="col-md-3">
      ...
      <div class="form-group col-md-3">
        <select id="inputState" class="form-control" onChange="location = this.options[this.selectedIndex].value;">
          ...
          <option value="../../Article/Accessoire/asc">Prix (- cher)</option>
          <option value="../../Article/Accessoire/desc">Prix (+ cher)</option>
        </select>
      </div>
    <div>
  <div>
...
<div class="row">
  ...
  <div class="row">
    <div class="col-12 text-center" style="color:black !importante">
      {{ $produits->links()}}
    </div>
  </div>
</div>
